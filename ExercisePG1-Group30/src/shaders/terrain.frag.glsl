...
void main()
{
	...
	*/
	...
	/* #TODO PG1.6.1: apply the Blinn-Phong lighting model
    	...
    	Hints:
	*/
	vec3 light_direction = normalize(light_position.xyz - v2f_vertex_position);
	vec3 view_direction = normalize(-v2f_vertex_position);
	...
	vec3 color = (diffuse + specular) * light_color * material_color + ambient * material_color;
